// derived from: http://stackoverflow.com/a/5350888/253773
...
function commonAncestor(node1, node2) {
  ...
  if (parents1[0].moduleName != parents2[0].moduleName) {
    throw "No common ancestor!";
  }

  for (var i = 0; i < parents1.length; i++) {
    if (parents2[i] === undefined || parents1[i].moduleName != parents2[i].moduleName) {
      return parents1[i - 1];
    }
  }
